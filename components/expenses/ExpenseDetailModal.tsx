...
export function ExpenseDetailModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-end justify-center p-4 sm:items-center">
      ...
      <div className="premium-modal-panel card relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-3xl p-6 shadow-xl sm:p-7">
        <button
          type="button"
          onClick={onClose}
        ...
        <div className="mt-5 rounded-2xl border p-4" style={{
          ...
          <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: "var(--evven-accent-primary)" }}>
            Amount
          </p>
          <p className="mt-2 text-3xl font-semibold" style={{ fontFamily: "var(--font-mono)", color: "var(--evven-accent-primary)" }}>
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          ...
          <div className="card rounded-2xl p-4">
            ...
            <p className="text-sm font-medium flex items-center gap-2" style={{ color: "var(--evven-text-primary)" }}>
        ...
        <div className="mt-5 rounded-2xl border p-4" style={{
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border p-3" style={{ borderColor: "var(--evven-border)" }}>
              <p className="mb-1 text-[11px] uppercase tracking-widest" style={{ color: "var(--evven-text-muted)" }}>
                Counterparty
              </p>
              <p className="text-sm font-medium" style={{ color: "var(--evven-text-primary)" }}>
                {counterpartyLabel}
        ...
        {summary ? (
          <div className="mt-5 rounded-2xl border p-4" style={{
            ...
            <p className="mt-2 text-sm" style={{ color: "var(--evven-text-primary)" }}>
              {summary}
            </p>
          </div>
        ) : null}
        ...
        {expense.notes ? (
          <div className="mt-5 rounded-2xl border p-4" style={{
            ...
            <p className="mt-2 text-sm leading-6" style={{ color: "var(--evven-text-primary)" }}>
              {expense.notes}
            </p>
          </div>
        ) : null}
        ...
        <div className="mt-5 rounded-2xl border p-4" style={{
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <p className="break-all text-xs font-mono" style={{ color: "var(--evven-text-primary)" }}>
                {expense.id}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="break-words text-sm font-medium" style={{ color: "var(--evven-text-primary)" }}>
        ...
        <div className="mt-6 grid gap-2 sm:grid-cols-2">
          ...
          <button
            ...
            style={{
              borderColor: "color-mix(in srgb, var(--evven-error) 30%, var(--evven-border))",
