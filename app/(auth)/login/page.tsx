...
function LoginForm() {
  ...
  return (
    <AuthCard
      outerClassName="relative isolate w-full max-w-[420px] animate-in fade-in slide-in-from-bottom-4 duration-500 lg:max-w-[400px]"
      innerClassName="card relative overflow-hidden rounded-[1.75rem] border border-border/60 p-6 shadow-[0_16px_50px_rgba(0,0,0,0.10)] sm:rounded-[2rem] sm:p-8 sm:shadow-[0_24px_80px_rgba(0,0,0,0.14)] sm:backdrop-blur-2xl"
    >
      <AuthHeader
        eyebrow="Log in"
        title="Welcome back."
